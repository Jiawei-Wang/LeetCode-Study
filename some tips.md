1. optimal solution uses all information in the question, for example if the question says the array is sorted, or values are unique, then the information must be used in the solution
