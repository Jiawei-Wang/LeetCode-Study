...
# a stone is connected to another stone if they share same row or same col
# so stone a can be connected to stone b on same row
# while stone b can be connected to stone c on same col
# and they together form a component
# each component will leave one stone and delete all others
# result = total number of stones - total number of components
class Solution:
